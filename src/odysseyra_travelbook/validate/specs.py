...
DEFAULTS = [
    ...
    Spec("accommodation_start_time", False,
         "the clock time an accommodation booking starts on the calendar (ICS export)",
         "a time HH:MM", '"22:00"', V_TIME),
    Spec("accommodation_end_time", False,
         "the clock time an accommodation night ends on the calendar (ICS export)",
         "a time HH:MM", '"00:00" (midnight)', V_TIME),
