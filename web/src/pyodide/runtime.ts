// Boots Pyodide, installs the local `odysseyra_travelbook` wheel (and its pure-Python
...
// the first load. The `odysseyra_travelbook` wheel itself is served locally and precached.
...
function bridge() {
  ...
  return pyodide.pyimport("odysseyra_bridge");
}
